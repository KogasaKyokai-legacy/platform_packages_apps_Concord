...
LOCAL_PACKAGE_NAME := ConcordGo
LOCAL_PRIVILEGED_MODULE := true
LOCAL_SYSTEM_EXT_MODULE := true
LOCAL_OVERRIDES_PACKAGES := Home Launcher2 Launcher3 Launcher3QuickStep Launcher3Go
LOCAL_REQUIRED_MODULES := privapp_whitelist_com.android.launcher3 privapp_whitelist_kogasa_launcher3.xml
...
LOCAL_PACKAGE_NAME := ConcordQuickStep
LOCAL_PRIVILEGED_MODULE := true
LOCAL_SYSTEM_EXT_MODULE := true
...
LOCAL_PACKAGE_NAME := ConcordQuickStepGo
LOCAL_PRIVILEGED_MODULE := true
LOCAL_SYSTEM_EXT_MODULE := true
